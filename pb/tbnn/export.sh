...
#在${GOPATH}bin 目录下安装生成 protoc-gen-gogofaster.exe
go install -v github.com/gogo/protobuf/protoc-gen-gogofaster

#在${GOPATH}bin 目录下安装生成 protoc-gen-msg.exe
#go install -v github.com/cellnet/protoc-gen-msg
go install -v trunk/cellnet/protoc-gen-msg
...
# 生成cellnet 消息注册文件
${BIN_PATH}/protoc_win32.exe --plugin=protoc-gen-msg=${BIN_PATH}/protoc-gen-msg${EXESUFFIX} --msg_out=autopb.go:. --proto_path="." *.proto
